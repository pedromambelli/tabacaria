 ...
 * @author pedro
 */
public class AlteracaoQuantidadeVenda extends javax.swing.JFrame {
    ...
    public AlteracaoQuantidadeVenda() {
        initComponents();
    }

    AlteracaoQuantidadeVenda(Item i, Venda v, VendaTableModel vtm, int flag) {
        this.item = i;
        this.venda = v;
        this.vendaTM = vtm;
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        this.venda.incluirItem(i);
        this.vendaTM.refresh();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlteracaoQuantidadeVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlteracaoQuantidadeVenda().setVisible(true);
            }
        });
    }
